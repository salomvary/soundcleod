...
Current version is 1.0.0-beta.2 (September 27, 2016) [see changes](https://github.com/salomvary/soundcleod/blob/master/CHANGELOG.md)

- [Download from
	here](https://github.com/salomvary/soundcleod/releases/download/1.0.0-beta.2/SoundCleod.dmg)
