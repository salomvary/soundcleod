...
Current version is 1.1.9 (March  3, 2017) [see changes](https://github.com/salomvary/soundcleod/blob/master/CHANGELOG.md)

### For macOS

- [Download macOS installer from
	here](https://github.com/salomvary/soundcleod/releases/download/v1.1.9/soundcleod-1.1.9.dmg)
...
- [Download Windows installer from
	here](https://github.com/salomvary/soundcleod/releases/download/v1.1.9/soundcleod-Setup-1.1.9.exe)
