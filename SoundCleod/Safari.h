...
- (void) closeSaving:(SafariSavo)saving savingIn:(id)savingIn;  // Close an object.
...
- (SafariDocument *) open:(id)x;  // Open an object.
- (void) print:(id)x printDialog:(BOOL)printDialog withProperties:(SafariPrintSettings *)withProperties;  // Print an object.
